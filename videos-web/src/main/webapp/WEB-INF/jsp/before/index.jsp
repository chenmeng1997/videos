...
<%@ page import="com.qf.service.SubjectService" %>
<%@ page import="com.qf.service.impl.SubjectServiceImpl" %>
<%@ page import="com.qf.entity.Subject" %>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <meta name="description"
          content="Y先生教育在线课程视频,为您提供java,python,HTML5,UI,PHP,大数据等学科经典视频教程在线浏览学习,
          精细化知识点解析,深入浅出,想学不会都难,Y先生教育,学习成就梦想！">
...
<header>
    <div class="container">
        ...
        <div id="userBlock" style="display:none;float:right">
            ...
            <a href="${pageContext.request.contextPath}/user/loginOut2" id="loginout">退出</a>
            <a href="showMyProfile" id="account">${sessionScope.userAccount}</a>
        </div>
...
<nav class="w100">
    <div class="container">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo"
             onclick="location.href='${pageContext.request.contextPath}/admin/tologin'" draggable="false">
        <ul class="text_13 f_right">
            <li>
                <a href="${pageContext.request.contextPath}/user/index" target="_blank">首页</a>
            </li>
            <li class="nav_down">
                ...
                <ul id="nav_down" class="t_center">
                    <c:forEach items="${subjectList}" var="subject">
                        <li>
                            <a target="_blank"
                               href="${pageContext.request.contextPath}/course/course/${subject.id}">
                                    ${subject.subjectName}
                            </a>
                        </li>
                    </c:forEach>

            ...
            <div class="proflle_tab_body">
                ...
                <div class="proflle_tab_workplace clearfix">
                    <div class="profile_avatar_area">
                        ...
                        <c:if test="${empty user.imgUrl}">
                            <img id="avatar" src="${pageContext.request.contextPath}/img/mn32.jpg" alt="">
                        </c:if>
                    ...
                    <div class="profile_ifo_area">
                        <form action="${pageContext.request.contextPath}/user/updatePassword">
                            ...
                            <div class="form_group">
                                ...
                                <input type="password" id="newPassword02" name="newPassword02">
                                <span id="passMsg"></span>
                            </div>

                            <div class="form_submit dd">
                                <input type="submit" value="保&#x3000;存">
                                  <a href="${pageContext.request.contextPath}/user/passwordSafe">

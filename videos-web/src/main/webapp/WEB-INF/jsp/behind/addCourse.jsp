...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/course/saveOrUpdate" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="courseTitle" value="${course.courseTitle}" placeholder="主讲人名称">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="courseDesc" class="form-control" value="${course.courseDesc}" placeholder="主讲人职位">
            </div>
        </div>
                    ...
                    <div class="input-group-btn">
                        ...
                        <ul id="selectCourse" class="dropdown-menu">
                            <c:forEach items="${subjectList}" var="subject">
                                <li value='${subject.id}'>
                                    <a href="#" onclick="showName(this,'${subject.id}',1)">${subject.subjectName}</a>
                                </li>
                            </c:forEach>
                        </ul>
                    </div>
